package com.soolr.api.config.interceptor;

import com.soolr.api.common.annotation.RateLimiter;
...
import com.soolr.api.common.utils.ResponseUtil;
...
public class LimitRaterInterceptor extends HandlerInterceptorAdapter {
    ...
    @Value("${api.rateLimit.enable}")
    private boolean rateLimitEnable;

    @Value("${api.rateLimit.limit}")
    private Integer limit;

    @Value("${api.rateLimit.timeout}")
