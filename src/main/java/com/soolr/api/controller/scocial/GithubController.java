...
import com.soolr.api.common.vo.GithubUserInfo;
...
@RequestMapping("/api/social/github")
@Controller
public class GithubController {

    @Value("${api.social.github.clientId}")
    private String clientId;

    @Value("${api.social.github.clientSecret}")
    private String clientSecret;

    @Value("${api.social.github.callbackUrl}")
