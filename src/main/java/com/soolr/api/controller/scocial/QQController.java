...
import com.soolr.api.common.vo.QQUserInfo;
...
@RequestMapping("/api/social/qq")
@Controller
public class QQController {

    @Value("${api.social.qq.appId}")
    private String appId;

    @Value("${api.social.qq.appKey}")
    private String appKey;

    @Value("${api.social.qq.callbackUrl}")
