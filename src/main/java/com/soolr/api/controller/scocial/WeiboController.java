...
import com.soolr.api.common.vo.AccessToken;
import com.soolr.api.common.vo.Result;
import com.soolr.api.common.vo.WeiboUserInfo;
...
@RequestMapping("/api/social/weibo")
@Controller
public class WeiboController {

    @Value("${api.social.weibo.appKey}")
    private String appKey;

    @Value("${api.social.weibo.appSecret}")
    private String appSecret;

    @Value("${api.social.weibo.callbackUrl}")
    private String callbackUrl;

    @Value("${api.social.callbackFeUrl}")
    private String callbackFeUrl;

    @Value("${api.social.callbackFeRelateUrl}")
