package com.soolr.api.generator;

import com.soolr.api.generator.bean.EntityOfEntity;
...
public class ApiGenerator {
     ...
     * 建议仅需修改
     */
    private static final String className = "File";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "文件管理";

    /**
     * 作者名
     * 建议仅需修改
     */
    private static final String author = "api";
     ...
     * 实体类对应包
     */
    private static final String entityPackage = "com.soolr.api.entity";

    /**
     * dao对应包
     */
    private static final String daoPackage = "com.soolr.api.dao";

    /**
     * service对应包
     */
    private static final String servicePackage = "com.soolr.api.service";

    /**
     * serviceImpl对应包
     */
    private static final String serviceImplPackage = "com.soolr.api.serviceimpl";

    /**
     * controller对应包
     */
    private static final String controllerPackage = "com.soolr.api.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com.soolr.api/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/com.soolr.api/entity/"+className+".java";
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/com.soolr.api/dao/"+className+"Dao.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir")+"/src/main/java/com.soolr.api/service/"+className+"Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir")+"/src/main/java/com.soolr.api/serviceimpl/"+className+"ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/src/main/java/com.soolr.api/controller/"+className+"Controller.java";
